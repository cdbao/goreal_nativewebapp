...
class TestLogChallengeEndpoint:
    ...
    def test_log_challenge_success(self, mock_log_challenge, client, sample_player_data):
    ...
    @patch('goreal.api.routes.sheets_client.log_challenge')
    def test_log_challenge_sheets_failure(self, mock_log_challenge, client, sample_player_data):
...
class TestSubmitChallengeEndpoint:
    ...
    def test_submit_challenge_success(self, mock_update_submission, client, sample_submission_data):
    ...
    @patch('goreal.api.routes.sheets_client.update_submission')
    def test_submit_challenge_not_found(self, mock_update_submission, client, sample_submission_data):
...
class TestErrorHandling:
    ...
    @patch('goreal.api.routes.sheets_client.log_challenge')
    def test_internal_server_error(self, mock_log_challenge, client, sample_player_data):
