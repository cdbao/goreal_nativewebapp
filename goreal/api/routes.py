...
from ..core.validators import validate_challenge_data, validate_submission_data, validate_status_query
...
def create_api_routes(app: Flask):
    ...
    def log_challenge():
        ...
        try:
            ...
            # Log the challenge
            success = sheets_client.log_challenge(
                player_id, player_name, challenge_id
            )
