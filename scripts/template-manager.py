...
class TemplateManager:
    ...
    def validate_template(self, template_name: str) -> bool:
        ...
        for var_name, var_config in variables.items():
            ...
            if var_type not in ["string", "integer", "boolean", "choice", "multiselect"]:
                print(f"❌ Invalid variable type '{var_type}' for '{var_name}'")
                return False
            
            if var_type in ["choice", "multiselect"] and "choices" not in var_config:
                print(f"❌ Variable '{var_name}' of type '{var_type}' must have 'choices'")
                return False
    ...
    def validate_structure(self, structure: Dict[str, Any], template_path: Path, prefix: str):
    ...
    def create_template_skeleton(self, template_name: str, template_type: str = "basic"):
        ...
        print("3. Test the template with: python scripts/create-project.py -t", template_name)
...
def main():
    ...
    parser.add_argument("command", choices=[
        "list", "validate", "create", "test", "version", "lint", "export", "import"
    ], help="Command to execute")
    
    parser.add_argument("--template", "-t", help="Template name")
    parser.add_argument("--type", help="Template type (for create command)", default="basic")
