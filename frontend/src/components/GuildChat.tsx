    ...
    return (
      <div className="guild-chat-error frosted-glass">
        <div className="error-content">
          ...
          <p>
            Bạn cần phải là thành viên của một Guild để sử dụng tính năng này.
          </p>
        </div>
      </div>
    );
    ...
    >
      ...
      <div className="chat-header">
        <div className="guild-info">
          <div className="guild-avatar animate-pulse">{guildInfo?.icon}</div>
      ...
      <div className="messages-container">
        {messages.length === 0 ? (
          <div className="empty-chat">
            ...
            <p>
              Hãy là người đầu tiên gửi lời chào đến các Chiến Binh khác trong{' '}
              {guildInfo?.displayName}!
            </p>
          </div>
        ) : (
            ...
            {messages.map((message, index) => (
              ...
              >
                ...
                <div className="message-content">
                  ...
                  <div
                    className={`message-bubble ${message.isSystemMessage ? 'system-bubble' : ''}`}
                  >
                    {message.message}
                  </div>
                </div>
