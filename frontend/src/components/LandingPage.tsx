          ...
          <div className="threat-content">
            ...
            <div className="threat-story">
              <div className="story-block">
                ...
                <p>
                  Một thế lực đen tối đang lan rộng khắp Aethelgard, khiến cho sức mạnh AURA 
                  của các Vệ Thần ngày càng suy yếu. Đó chính là "Sự Trì Hoãn" - 
                  kẻ thù nguy hiểm nhất của mọi chiến binh.
                </p>
              </div>
              ...
              <div className="story-block">
                ...
                <p>
                  Khi Sự Trì Hoãn xâm chiếm tâm hồn, các Vệ Thần mất đi khát vọng chiến đấu, 
                  không còn rèn luyện bản thân và dần trở nên yếu đuối trước thử thách.
                </p>
              </div>
              ...
              <div className="story-block">
                ...
                <p>
                  Nếu không có những Vệ Thần mạnh mẽ để bảo vệ, hòn đảo Aethelgard 
                  sẽ chìm vào bóng tối vĩnh viễn. Thời gian đang cạn kiệt...
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="academy-story">
              <div className="academy-intro">
                ...
                <p className="academy-description">
                  Trong lúc thế giới tối tăm nhất, Học Viện GoREAL được thành lập 
                  với một sứ mệnh thiêng liêng: biến những thử thách ảo thành 
                  sức mạnh thực sự.
                </p>
              </div>
              ...
              <div className="philosophy-blocks">
                <div className="philosophy-block">
                  ...
                  <h3>Game Ảo</h3>
                  <p>Chúng tôi tin rằng việc hoàn thành các quest trong game có thể rèn luyện ý chí và kỷ luật</p>
                </div>
                ...
                <div className="philosophy-block">
                  ...
                  <p>Mỗi nhiệm vụ hoàn thành sẽ giúp bạn phát triển kỹ năng và thói quen tích cực trong cuộc sống</p>
                </div>
              </div>
              ...
              <div className="aura-explanation">
                ...
                <p>
                  ...
                  kỷ luật và khát vọng vượt qua giới hạn bản thân. 
                  Khi AURA của bạn tăng cao, bạn sẽ trở thành Vệ Thần thực thụ, 
                  không chỉ trong game mà cả trong đời thực.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="section-content">
          <div className="cta-content">
            ...
            <p className="cta-description">
              Hành trình trở thành Vệ Thần bắt đầu từ đây. 
              Hãy gia nhập Titans' Guild và cùng chúng tôi cứu rỗi Aethelgard khỏi Sự Trì Hoãn!
            </p>
