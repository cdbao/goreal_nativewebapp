...
export const GUILDS: Record<GuildId, GuildInfo> = {
  titans: {
    ...
    displayName: 'Vệ Thần',
    description:
      'Guild của những chiến binh mạnh mẽ, bảo vệ Học viện với sức mạnh tuyệt đối',
    theme: {
  ...
  illumination: {
    ...
    description:
      'Guild của những học giả thông thái, khai sáng tri thức cho thế giới',
    theme: {
  ...
  envoys: {
    ...
    displayName: 'Ngôn Sứ',
    description:
      'Guild của những sứ giả hòa bình, kết nối các vùng đất bằng ngoại giao',
    theme: {
